...
const Task = ({ task }: TaskProps) => {
  ...
  console.log("ATTTTTT", task.attachments);
    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="flex items-start justify-between">
          ...
          <button className="flex size-6 flex-shrink-0 items-center justify-center dark:text-neutral-500">
            <EllipsisVerticalIcon size={26} />
          </button>
        </div>
        ...
        <div className="text-xs text-gray-500 dark:text-neutral-500">
          ...
          {formattedDueDate && <span className="">{formattedDueDate}</span>}
        </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <div className="flex items-center text-gray-600 dark:text-neutral-500">
